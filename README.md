...
sock also contains the production TMH implementation.

- use `--kv-layout tmh` to enable the physical TMH KV path inside the vendored engine
- use the default `standard` layout to keep the native paged KV path
